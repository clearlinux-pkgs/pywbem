...
Version  : 1.1.3
Release  : 59
URL      : https://files.pythonhosted.org/packages/35/a5/569e9c88437b81a31de972948340c2e25b9b22a1f44819f7c743c06cbe2b/pywbem-1.1.3.tar.gz
...
%prep
%setup -q -n pywbem-1.1.3
cd %{_builddir}/pywbem-1.1.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1609781127
...
cp %{_builddir}/pywbem-1.1.3/LICENSE.txt %{buildroot}/usr/share/package-licenses/pywbem/caeb68c46fa36651acf592771d09de7937926bb3
